...
namespace IndiaTango.Tests
{
    ...
    class DatasetTest
    {
        ...
        private Site _b = new Site(1, "dsf", "asdf", new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new GPSCoords(0, 0, "arcGis"));
        ...
        public void BuoyGetSetTest()
        {
            ...
            _b = new Site(2, "dsf", "asdf", new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new GPSCoords(0, 0, "arcGis"));
            _ds1.Site = _b;
            Assert.AreEqual(_b, _ds1.Site);
        }
