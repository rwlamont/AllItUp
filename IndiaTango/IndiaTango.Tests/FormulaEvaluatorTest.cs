...
namespace IndiaTango.Tests
{
    ...
    class FormulaEvaluatorTest
    {
        ...
        private Site _s = new Site(1, "dsf", "asdf", new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new Contact("asdf", "asdf", "adsf@sdfg.com", "uerh", "sadf"), new GPSCoords(0, 0, "arcGis"));
